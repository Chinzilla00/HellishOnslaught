...
namespace HellishOnslaught.Items
{
    class JooksDenial : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            item.shootSpeed = 16f;
            item.knockBack = 2.5f;
            item.damage = 52 * PlayerFile.powerint();
            item.melee = true;
            item.channel = true;
            item.noMelee = true;
            item.noUseGraphic = true;
            item.UseSound = SoundID.Item1;
            item.shoot = ModContent.ProjectileType<JooksDenialProj>();
        }
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            tooltips.Add(new TooltipLine(mod, "Tooltip", "After getting so heated with it, He lost his temper and broke the string."));
            tooltips.Add(new TooltipLine(mod, "Tooltip2", "When both his temper and the string broke, all hell REALLY broke loose..."));
            ...
            foreach (TooltipLine line in tooltips)
            {
                if (line.mod == "Terraria" && line.Name == "ItemName")
                {
                    ...
                    line.text = "[c/" + color0.Hex3() + ":J]" + "[c/" + color1.Hex3() + ":o]" + "[c/" + color2.Hex3() + ":o]" + "[c/" + color3.Hex3() + ":k]" + "[c/" + color4.Hex3() + ":']" + "[c/" + color5.Hex3() + ":s]" + "[c/" + color6.Hex3() + ": ]" + "[c/" + color7.Hex3() + ":D]" + "[c/" + color8.Hex3() + ":e]" + "[c/" + color9.Hex3() + ":n]" + "[c/" + color10.Hex3() + ":i]" + "[c/" + color11.Hex3() + ":a]" + "[c/" + color12.Hex3() + ":l]";
                }
